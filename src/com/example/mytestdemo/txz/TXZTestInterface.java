...
public class TXZTestInterface implements InitListener, ActiveListener{
	...
	public void Init(Context context) {
		...
		m_context = context;
		String appId = context.getResources().getString(R.string.txz_sdk_init_app_id);
		String appToken = context.getResources().getString(R.string.txz_sdk_init_app_token);
		// 设置初始化参数
		mInitParam = new InitParam(appId, appToken);
		String[] wakeupKeywords = context.getResources().getStringArray(R.array.txz_sdk_init_wakeup_keywords);
		mInitParam.setWakeupKeywordsNew(wakeupKeywords);
		mInitParam.setFloatToolType(FloatToolType.FLOAT_NONE);
		TXZConfigManager.getInstance().initialize(context, mInitParam, this, this);
...
//		TXZAsrManager.getInstance().setAsrTool(new AsrToolInterface());
	...
	public void onSuccess() {
		...
		LogUtil.d("TXZNaviSettingReceiver.isFirstInit:"+TXZNaviSettingReceiver.isFirstInit);
...
//		cmdListenerChangeRouteTypeOptimal();
		cmdListenerOpenAddressBook();
		cmdListenerCloseAddressBook();
...
//		cmdListenerGoToCompany();
		...
		cmdListenerCloseRoutePlan();
		cmdListenerOpenEagelView();
//		cmdListenerOpenDoubleScreen();
		cmdListenerSingleScreen();
		cmdListenerOpenDetail();
		cmdListenerCloseDetail();
		cmdListenerChangeViewMode();
		cmdListenerZoomOut();
		cmdListenerZoomIn();
		cmdListenerBroadCastAgain();
		cmdListenerNextServiceDistance();
...
*/	}
	...
	private void cmdListenerStartNavi() {
		...
		TXZAsrManager.getInstance().regCommand(new String[] {"我的地图","我的导航","导航","打开导航", "启动导航", "切换到导航" },"CMD_START_NAVI");
	...
	private void cmdListenerOpenAddressBook() {
		TXZAsrManager.getInstance().addCommandListener(new CommandListener() {
			@Override
			public void onCommand(String arg0, String arg1) {
				cmdCommandListener("CMD_OPEN_ADDR",arg1,TXZBasic.ACTION_TYPE_VIEWADDRESSBOOK_OPEN);
			}
		});
		TXZAsrManager.getInstance().regCommand(new String[] { "打开地址簿", "查看地址薄","打开我的地址", "地址薄", "选择地址", "查看保存的地址" },"CMD_OPEN_ADDR");
	}
	...
	private void cmdListenerCloseAddressBook() {
		TXZAsrManager.getInstance().addCommandListener(new CommandListener() {
			@Override
			public void onCommand(String arg0, String arg1) {
					cmdCommandListener("CMD_CLOSE_ADDR",arg1,TXZBasic.ACTION_TYPE_VIEWADDRESSBOOK_CLOSE);
			}
		});
		TXZAsrManager.getInstance().regCommand(new String[] { "关闭地址簿", "关闭地址" },"CMD_CLOSE_ADDR");
	}
	...
	private void cmdListenerOpenCalendar() {
		...
		TXZAsrManager.getInstance().regCommand(new String[] {"打开日历" },"CMD_OPEN_CALENDAR");
	...
	private void cmdListenerOpenFM() {
		...
		TXZAsrManager.getInstance().regCommand(new String[] {"打开广播" },"CMD_OPEN_FM");
...
//					AppMgrToolInterface.getInstance().openApp("com.example.mynewqq");
		...
		TXZAsrManager.getInstance().regCommand(new String[] {"打开酷我" },"CMD_OPEN_KUWO");
...
//					closeAppByPackageName("com.example.mynewqq");
					killProcessByPackageName2(MyTestApplication.getInstance().getApplicationContext(), "cn.kuwo.kwmusiccar");
					pauseMusic();
				}
				Log.d("RituNavi", "arg0:"+arg0+"arg1:"+arg1);
			}
		});
		TXZAsrManager.getInstance().regCommand(new String[] {"关闭酷我" ,"退出酷我"},"CMD_CLOSE_KUWO");
...
//					AppMgrToolInterface.getInstance().openApp("com.example.mynewqq");
		...
		TXZAsrManager.getInstance().regCommand(new String[] {"打开微信" },"CMD_OPEN_WEIXIN");
...
//					closeAppByPackageName("com.example.mynewqq");
					killProcessByPackageName2(MyTestApplication.getInstance().getApplicationContext(), "com.example.mynewqq");
				}
				Log.d("RituNavi", "arg0:"+arg0+"arg1:"+arg1);
			}
		});
		TXZAsrManager.getInstance().regCommand(new String[] {"关闭微信" ,"退出微信"},"CMD_CLOSE_WEIXIN");
...
//					AppMgrToolInterface.getInstance().openApp("com.example.mytestdemo");
		...
		TXZAsrManager.getInstance().regCommand(new String[] {"打开测试" },"CMD_OPEN_TEST");
...
//					closeAppByPackageName("com.example.mytestdemo");
					killProcessByPackageName2(MyTestApplication.getInstance().getApplicationContext(), "com.example.mytestdemo");
...
//					pauseMusic();
		...
		TXZAsrManager.getInstance().regCommand(new String[] {"关闭测试" ,"退出测试"},"CMD_CLOSE_TEST");
	...
	private void cmdListenerOpenSettings() {
		...
		TXZAsrManager.getInstance().regCommand(new String[] {"打开导航设置" },"CMD_OPEN_SETTINGS");
		...
		TXZAsrManager.getInstance().addCommandListener(new CommandListener() {
			...
			public void onCommand(String arg0, String arg1) {
				if ("CMD_CLOSE_SETTINGS".equals(arg1)) {
					...
					killProcessByPackageName(MyTestApplication.getInstance().getApplicationContext(), "cn.ritu.settings");
				}
				Log.d("RituNavi", "arg0:"+arg0+"arg1:"+arg1);
			}
		});
		TXZAsrManager.getInstance().regCommand(new String[] {"关闭导航设置" ,"退出导航设置"},"CMD_CLOSE_SETTINGS");
	...
	private void cmdListenerOpenOnlineMap() {
		...
		TXZAsrManager.getInstance().regCommand(new String[] {"打开在线地图" },"CMD_OPEN_ONLINE_MAP");
	...
	private void cmdListenerOpenWeixinAss() {
		...
		TXZAsrManager.getInstance().regCommand(new String[] {"打开微信助手" },"CMD_OPEN_WEIXIN_ASSISTANT");
	...
	private void cmdListenerOpenBluetoothPhone() {
		...
		TXZAsrManager.getInstance().regCommand(new String[] {"打开蓝牙电话" },"CMD_OPEN_BLUETOOTH_PHONE");
	...
	private void cmdListenerOpenOnlineFM() {
		...
		TXZAsrManager.getInstance().regCommand(new String[] {"打开网络电台" },"CMD_OPEN_ONLINE_FM");
        ...
        TXZAsrManager.getInstance().addCommandListener(new CommandListener() {
            ...
            public void onCommand(String arg0, String arg1) {
                if ("CMD_CLOSE_ONLINE_FM".equals(arg1)) {
                    Log.d("RituNavi","XmPlayerManager isPlaying "+
                XmPlayerManager.getInstance(MyTestApplication.getInstance().getApplicationContext()).isPlaying());
                    XmPlayerManager.getInstance(MyTestApplication.getInstance().getApplicationContext()).stop();
                    Log.d("RituNavi","XmPlayerManager stop "+"com.ximalaya.ting.android");
//                    killProcessByPackageName2(MyTestApplication.getInstance().getApplicationContext(),"com.ximalaya.ting.android");
                }
            }
        });
        TXZAsrManager.getInstance().regCommand(new String[] {"关闭网络电台" ,"退出网络电台"},"CMD_CLOSE_ONLINE_FM");
	...
	private void cmdListenerOpenOnlineShop() {
		...
		TXZAsrManager.getInstance().regCommand(new String[] {"打开应用商店" },"CMD_OPEN_ONLINE_SHOP");
	...
	private void cmdListenerOpenFileManager() {
		...
		TXZAsrManager.getInstance().regCommand(new String[] {"打开文件管理" },"CMD_OPEN_FILE_MANAGER");
		...
		TXZAsrManager.getInstance().addCommandListener(new CommandListener() {
			...
			public void onCommand(String arg0, String arg1) {
				if ("CMD_OPEN_ONE_WIFI".equals(arg1)) {
					openAppByPackageNameWithAction("cn.ritu.launcher", "cn.ritu.start.wifi");
				}
				Log.d("RituNavi", "arg0:"+arg0+"arg1:"+arg1);
			}
		});
		TXZAsrManager.getInstance().regCommand(new String[] {"打开一键WIFI" },"CMD_OPEN_ONE_WIFI");
...
//					TXZSysManager.getInstance().setAppMgrTool(AppMgrToolInterface.getInstance());
					AppMgrToolInterface.getInstance().openApp("com.libtop.weitu");
				}
				Log.d("RituNavi", "arg0:"+arg0+"arg1:"+arg1);
			}
		});
		TXZAsrManager.getInstance().regCommand(new String[] {"打开微图" },"CMD_OPEN_WEITU");
		...
		TXZAsrManager.getInstance().addCommandListener(new CommandListener() {
			...
			public void onCommand(String arg0, String arg1) {
				if ("CMD_CLOSE_WEITU".equals(arg1)) {
					Log.d("RituNavi","killBackgroundProcesses 0 "+"com.libtop.weitu");
//					closeAppByPackageName("com.libtop.weitu");
					killProcessByPackageName2(MyTestApplication.getInstance().getApplicationContext(),"com.libtop.weitu");
//				SuUtil.kill("com.libtop.weitu");
//					TXZSysManager.getInstance().setAppMgrTool(AppMgrToolInterface.getInstance());
					AppMgrToolInterface.getInstance().closeApp("com.libtop.weitu");
				}
			}
		});
		TXZAsrManager.getInstance().regCommand(new String[] {"关闭微图" ,"退出微图"},"CMD_CLOSE_WEITU");
		Log.d("RituNavi", "正在为您注册关闭微图命令");
	}
	
	private void openAppByPackageName(String packageName){
		PackageManager manager = MyTestApplication.getInstance().getApplicationContext().getPackageManager();
...
//		intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
	...
	private void openAppByPackageNameWithAction(String packageName,String action){
		PackageManager manager = MyTestApplication.getInstance().getApplicationContext().getPackageManager();
		Intent intent = manager.getLaunchIntentForPackage(packageName);
		intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
	...
	private void closeAppByPackageName(String packageName){
		ActivityManager am = (ActivityManager) MyTestApplication.getInstance().getApplicationContext().getSystemService(Context.ACTIVITY_SERVICE);
		try {
	 ...
	 private void killProcessByPackageName(Context context ,String packageName) { 
		 ...
		 count++;
			...
			Log.d("RituNavi","forceStopPackage kill process size is "+count+", clean memory is "+cleanMem+"M");
	    }  
...
//	}
	...
	private void cmdCommandListener(String cmd, String arg1,int type){
		if (cmd.equals(arg1)) {
			...
			if(type!=-1){
				...
				intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
				ComponentName component = new ComponentName(TXZ_PACKAGE_NAME,TXZ_ACTIVITY_NAME);
	...
	public void transferCMD(int command) 
	{
	    ...
	    ComponentName componentName = new ComponentName(TXZ_PACKAGE_NAME, TXZ_ACTIVITY_NAME);
