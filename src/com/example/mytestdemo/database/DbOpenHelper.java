...
public class DbOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String RANDOM_IDS_TABLE_CREATE = "CREATE TABLE "
            ...
            + " TEXT,"+UserDao.COLUMN_NAME_RANDOM_AUTO_IDS+" INTEGER PRIMARY KEY AUTOINCREMENT);";
...
//		return DemoHelper.getInstance().getCurrentUsernName() + "_demo.db";
	...
	public void onCreate(SQLiteDatabase db) {
		...
		Log.d("RituNavi", "DbOpenHelper database onCreate");
	...
	/*	if (oldVersion < 3) {
		...
		Log.d("RituNavi", "DbOpenHelper database onUpgrade");
	}
	...
	public void closeDB() {
		...
		Log.d("RituNavi", "DbOpenHelper database closeDB");
	}
