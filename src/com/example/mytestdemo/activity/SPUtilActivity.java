...
public class SPUtilActivity extends BaseActivity implements OnClickListener {
	...
	private void saveData() {
		...
		if (s1.equals("")) {
			Toast.makeText(SPUtilActivity.this, "��������Ϊ��", Toast.LENGTH_SHORT)
					.show();
			return;
		}
		if (s2.equals("")) {
			Toast.makeText(SPUtilActivity.this, "���벻��Ϊ��", Toast.LENGTH_SHORT)
					.show();
			return;
		}
		if (s3.equals("")) {
			Toast.makeText(SPUtilActivity.this, "��Ǯ����Ϊ��", Toast.LENGTH_SHORT)
					.show();
			return;
		}
		if (s4.equals("")) {
			Toast.makeText(SPUtilActivity.this, "�Ƿ��в���Ϊ��", Toast.LENGTH_SHORT)
					.show();
			return;
		}
		if (!(s4.equals("true") || s4.equals("false"))) {
			Toast.makeText(SPUtilActivity.this, "�Ƿ���������������" + s4,
					Toast.LENGTH_SHORT).show();
			return;
		}
